...
int getinfo(student pa[], int n)
{
    ...
    for (int i = 0 ; i < n; ++i)
    {
        ...
        std::cin >> pa[i].hobby;
        std::cout << "Please enter your ooplevel: ";
...
void display1(student st)
{
    ...
    std::cout << "Ooplevel: " << st.ooplevel << '\n';
}

void display2(const student * ps)
{
    std::cout << "Full name: " << ps->fullname << '\n';
    std::cout << "Hobby: " << ps->hobby << '\n';
    std::cout << "Ooplevel: " << (*ps).ooplevel << '\n';
}
...
void display3(const student pa[], int n)
{
    for (int i = 0; i < n; ++i)
    {
        std::cout << "Full name: " << pa[i].fullname << '\n';
        std::cout << "Hobby: " << pa[i].hobby << '\n';
        std::cout << "Ooplevel: " << pa[i].ooplevel << '\n';
    }
}